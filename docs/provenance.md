...
|---|---|
| `standard/v0.5.0-alpha.4` | `UNVERIFIED` — shipped by this SDK, but not rebuilt from `d37ca8dcc08527043d9115710573ea2459958908` and compared by sha256. That reproduction, using its pinned Aiken toolchain in a throwaway clone, is required before this row can say `VERIFIED` |
